...
public class Composicion2 {
    ...
    public static void main(String[] args) {
       ...
       System.out.println("LIBRO: Arranque y apagado del motor\n");
           // DECLARACION Y DEFINICION DE OBJETOS      
        Libro Controles_Instrumentos=new Libro ("Arranque y apagado del"
                + " motor", 1234567896, "Chevrolet", 2020);
        Pagina pagina1=new Pagina("Asegurese que todos los interruptores "
                + "esten en la posicion de desactivada ", 1);
        Pagina pagina2=new Pagina("Gire interrupto de arranque a posicion "
                + "ON verifique luces y combustible normal",0);
